...
struct ImGuiStyle
{
    ...
    bool        AntiAliasedLinesUseTex;     // Enable anti-aliased lines/borders using planettextures where possible. Require backend to render with bilinear filtering. Latched at the beginning of the frame (copied to ImDrawList).
...
// The maximum line width to bake anti-aliased planettextures for. Build atlas with ImFontAtlasFlags_NoBakedLines to disable baking.
...
enum ImDrawListFlags_
{
    ...
    ImDrawListFlags_AntiAliasedLines        = 1 << 0,  // Enable anti-aliased lines/borders (*2 the number of triangles for 1.0f wide line or lines thin enough to be drawn using planettextures, otherwise *3 the number of triangles)
    ImDrawListFlags_AntiAliasedLinesUseTex  = 1 << 1,  // Enable anti-aliased lines/borders using planettextures when possible. Require backend to render with bilinear filtering.
...
struct ImDrawList
{
    ...
    //   In future versions we will use planettextures to provide cheaper and higher-quality circles.
...
enum ImFontAtlasFlags_
{
    ...
    ImFontAtlasFlags_NoBakedLines       = 1 << 2    // Don't build thick line planettextures into the atlas (save a little texture memory). The AntiAliasedLinesUseTex features uses them, otherwise they will be rendered using polygons (more expensive for CPU/GPU).
};
